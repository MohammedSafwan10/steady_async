...
| `steady_async_bloc` | 0.2.0 | 3.22.3 | 3.4 | `flutter_bloc >=9.1.1 <10.0.0` | Flutter 3.44.3 / Dart 3.12.2 |
| `steady_async_riverpod` | 0.2.0 | 3.29.0 | 3.7 | `flutter_riverpod >=3.3.2 <4.0.0` | Flutter 3.44.3 / Dart 3.12.2 |
