...
| Package | Purpose | Minimum SDK |
| --- | --- | --- |
| `steady_async` | Independent state, builders, actions, pagination, theme, locales | Flutter 3.22 / Dart 3.4 |
| `steady_async_riverpod` | Riverpod 3 `AsyncValue` conversion and view | Flutter 3.22 / Dart 3.7 |
| `steady_async_bloc` | Typed BLoC/Cubit selector view | Flutter 3.22 / Dart 3.4 |
